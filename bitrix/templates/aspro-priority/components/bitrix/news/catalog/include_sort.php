		...
		<div class="row">
			...
			<div class="col-md-7 col-sm-5 col-xs-5 ordering-wrap">
				<?if($arTheme['SHOW_SMARTFILTER']['VALUE'] == 'Y'):?>
					<div class="filter-action font_xs<?=($arTheme['SHOW_SMARTFILTER']['DEPENDENT_PARAMS']['FILTER_VIEW']['VALUE'] == 'HORIZONTAL' ? ' showen' : '')?>"><span class="with_dropdown"><?=GetMessage('FILTER_TITLE');?></span></div>
				<?endif;?>
