		...
		<div class="maxwidth-theme">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="flexslider wsmooth unstyled row front dark-nav view-control navigation-vcenter" data-plugin-options='{"smoothHeight": true, "directionNav": true, "controlNav" :false, "animationLoop": true, "slideshow": false, <?=($slideshowSpeed >= 0 ? '"slideshowSpeed": '.$slideshowSpeed.',' : '')?> <?=($animationSpeed >= 0 ? '"animationSpeed": '.$animationSpeed.',' : '')?> <?=($isNormalBlock ? '"itemMargin": 32,' : '');?> "counts": [1, 1, 1]}'>
