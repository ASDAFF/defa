				...
				<div class="col-md-3 hidden-sm hidden-xs">
					<div class="pull-left">
						<div class="top-description">
							...
							<div>
								<span class="callback-block hover sep animate-load twosmallfont colored" data-event="jqm" data-param-id="<?=CCache::$arIBlocks[SITE_ID]["aspro_priority_form"]["aspro_priority_callback"][0]?>" data-name="callback"><?=GetMessage("S_CALLBACK")?></span>
							</div>
						</div>
					</div>
					<div class="pull-right">
						<div class="top-description">
							...
							<?=CPriority::ShowBasketLink('top-btn hover pull-right');?>
						</div>
					</div>
				</div>
			</div>
