<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?>
	...
	<div class="form-wr">
		<form method="post" id="one_click_buy_form" action="<?=$arResult['SCRIPT_PATH']?>/script.php">
			...
			<?endforeach;?>
			<?if(\Bitrix\Main\Config\Option::get('aspro.next.stock', 'ONE_CLICK_BUY_CAPTCHA', 'N') == 'Y'):?>
			...
			<?if($arParams["SHOW_LICENCE"] == "Y"):?>
				<div class="form">
					<div class="licence_block filter label_block">
						<input type="checkbox" id="licenses_popup_OCB" <?=(COption::GetOptionString("aspro_next_stock", "LICENCE_CHECKED", "N") == "Y" ? "checked" : "");?> name="licenses_popup_OCB" required value="Y">
