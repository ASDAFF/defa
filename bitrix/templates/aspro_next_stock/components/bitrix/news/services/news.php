...
$arItemFilter = CNextStock::GetCurrentSectionElementFilter($arResult["VARIABLES"], $arParams, false);
$arSubSectionFilter = CNextStock::GetCurrentSectionSubSectionFilter($arResult["VARIABLES"], $arParams, false);
...
$arSubSections = CNextCacheStock::CIBlockSection_GetList(array("CACHE" => array("TAG" => CNextCacheStock::GetIBlockCacheTag($arParams["IBLOCK_ID"]), "MULTI" => "Y", "CACHE_GROUP" => array($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()))), $arSubSectionFilter, false, array("ID"));
