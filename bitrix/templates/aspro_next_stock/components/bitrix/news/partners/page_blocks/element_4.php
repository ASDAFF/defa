...
<div class="right_block wide_N">
	<div class="middle">
		...
		?>
		<?$arItems = CNextCacheStock::CIBLockElement_GetList(array('CACHE' => array("MULTI" =>"Y", "TAG" => CNextCacheStock::GetIBlockCacheTag($catalogIBlockID))), array("IBLOCK_ID" => $catalogIBlockID, "ACTIVE"=>"Y", "PROPERTY_".$arParams["LINKED_PRODUCTS_PROPERTY"] => $arElement["ID"] ), false, false, array("ID", "IBLOCK_ID", "IBLOCK_SECTION_ID"));
