		...
		<table class="colored fixed" height="100%" width="100%">
			...
			<tfoot>
				...
				<tr data-id="total_buttons" class="bottom_btn">
					...
					<?endif;?>
					<td class="back_btn">
						<?if(!$arError["ERROR"] && \Bitrix\Main\Config\Option::get("aspro_next_stock", "SHOW_ONECLICKBUY_ON_BASKET_PAGE", "Y") == "Y"){?>
					...
					<td width="19%">
						<?if(!$arError["ERROR"]){?>
							<?if (\Bitrix\Main\Config\Option::get("aspro_next_stock", "SHOW_ONECLICKBUY_ON_BASKET_PAGE", "Y") == "Y"):?>
