					...
					<?foreach($arResult['ITEMS'] as $key => $arItem){
						...
						elseif($arItem["OFFERS"]){
							...
							if(!$arItem['OFFERS_PROP']){
								...
								$arAddToBasketData = CNextStock::GetAddToBasketArray($arItem["OFFERS"][0], $totalCount, $arParams["DEFAULT_COUNT"], $arParams["BASKET_URL"], false, $arItemIDs["ALL_ITEM_IDS"], 'small', $arParams);
							}
						}
							...
							<div class="inner_wrap">
								...
								<div class="item_info <?=$arParams["TYPE_SKU"]?>">
									...
									<div class="cost prices clearfix">
										<?if( $arItem["OFFERS"]){?>
											<?\Aspro\Functions\CAsproSkuStock::showItemPrices($arParams, $arItem, $item_id, $min_price_id, $arItemIDs);?>
										<?}elseif ( $arItem["PRICES"] ){?>
											...
											<?\Aspro\Functions\CAsproItemStock::showItemPrices($arParams, $arItem["PRICES"], $strMeasure, $min_price_id);?>
										<?}?>
									</div>
										...
										<?if(!empty($arItem['OFFERS_PROP'])){?>
											<div class="sku_props">
												<div class="bx_catalog_item_scu wrapper_sku" id="<? echo $arItemIDs["ALL_ITEM_IDS"]['PROP_DIV']; ?>">
													<?$arSkuTemplate = array();?>
													<?$arSkuTemplate=CNextStock::GetSKUPropsArray($arItem['OFFERS_PROPS_JS'], $arResult["SKU_IBLOCK_ID"], $arParams["DISPLAY_TYPE"], $arParams["OFFER_HIDE_NAME_PROPS"]);?>
