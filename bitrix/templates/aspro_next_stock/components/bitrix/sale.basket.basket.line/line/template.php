...
{*/
	...
	$title_basket =  ($arResult['NUM_PRODUCTS'] ? GetMessage("BASKET_COUNT", array("#PRICE#" => CNextStock::clearFormatPrice($arResult['TOTAL_PRICE']))) : GetMessage("EMPTY_BLOCK"));
	$title_delay = ($sDelayPrice ? GetMessage("BASKET_DELAY_COUNT", array("#PRICE#" => CNextStock::clearFormatPrice($sDelayPrice))) : GetMessage("EMPTY_BLOCK"));
