									...
									<?ob_start();?>
										<td class="text <?=$arItem["PROPERTIES"]["TEXT_POSITION"]["VALUE_XML_ID"];?>">
                                            ...
                                            <div class="banner-left-content">
                                                ...
                                                $bShowButton3 = (strlen($arItem['PROPERTIES']['BUTTON3TEXT']['VALUE']) && strlen($arItem['PROPERTIES']['BUTTON3LINK']['VALUE']));
                                                ?>
                                                <?if($arItem["NAME"]):?>
                                                ...
                                                <?if($bShowButton1 || $bShowButton2 || ($bShowVideo && !$bVideoAutoStart)):?>
                                                    <div class="banner_buttons">
                                                        ...
                                                        <?elseif($bShowButton1 || $bShowButton2):?>
                                                            ...
                                                            <?endif;?>
                                                            <?if($bShowButton1):?>
                                                                <a href="<?=$arItem["PROPERTIES"]["BUTTON1LINK"]["VALUE"]?>" class="<?=!empty($arItem["PROPERTIES"]["BUTTON1CLASS"]["VALUE"]) ? $arItem["PROPERTIES"]["BUTTON1CLASS"]["VALUE"] : "btn btn-default btn-lg white-banner-btn"?>" <?=(strlen($target) ? 'target="'.$target.'"' : '')?>>
                                                                    <span><?=$arItem["PROPERTIES"]["BUTTON1TEXT"]["VALUE"]?></span>
                                                                    <i class="arrow_main">
                                                            ...
                                                            <?endif;?>
                                                            <?if($bShowButton2):?>
                                                                <a href="<?=$arItem["PROPERTIES"]["BUTTON2LINK"]["VALUE"]?>" class="<?=!empty( $arItem["PROPERTIES"]["BUTTON2CLASS"]["VALUE"]) ? $arItem["PROPERTIES"]["BUTTON2CLASS"]["VALUE"] : "btn btn-default btn-lg white-banner-btn"?>" <?=(strlen($target) ? 'target="'.$target.'"' : '')?>>
                                                                    <span><?=$arItem["PROPERTIES"]["BUTTON2TEXT"]["VALUE"]?></span>
                                                                    <i class="arrow_main">
                                                                        <svg version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                                             viewBox="0 0 25.5 21.4" style="enable-background:new 0 0 25.5 21.4;" xml:space="preserve">
                                                                            <g>
                                                            ...
                                                            <?endif;?>
                                                            <?if($bShowButton3):?>
                                                                <a href="<?=$arItem["PROPERTIES"]["BUTTON3LINK"]["VALUE"]?>" class="<?=!empty( $arItem["PROPERTIES"]["BUTTON3CLASS"]["VALUE"]) ? $arItem["PROPERTIES"]["BUTTON3CLASS"]["VALUE"] : "btn btn-default btn-lg dark-banner-btn"?>" <?=(strlen($target) ? 'target="'.$target.'"' : '')?>>
                                                                    <span><?=$arItem["PROPERTIES"]["BUTTON3TEXT"]["VALUE"]?></span>
                                                                    <i class="arrow_main">
                                                                        <svg version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                                             viewBox="0 0 25.5 21.4" style="enable-background:new 0 0 25.5 21.4;" xml:space="preserve">
                                                                            <g>
