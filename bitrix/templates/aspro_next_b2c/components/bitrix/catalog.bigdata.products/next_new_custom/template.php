		...
		<div class="viewed_slider common_product wrapper_block recomendation <?=$class_block;?>">
			...
			<div class="all_wrapp basket">
				<div class="content_inner">
					<div class="tabs_slider slides catalog_block basket-slider">
						<?foreach ($arResult['ITEMS'] as $key => $arItem){?>
							<?$strMainID = $this->GetEditAreaId($arItem['ID'] . $key);?>
							<div class="catalog_item visible" id="<?=$strMainID;?>">
								<?
								...
								$arAddToBasketData = CNextB2c::GetAddToBasketArray($arItem, $totalCount, $arParams["DEFAULT_COUNT"], $arParams["BASKET_URL"], true);
