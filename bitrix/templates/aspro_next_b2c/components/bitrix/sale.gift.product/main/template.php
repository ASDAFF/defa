...
if (!empty($arResult['ITEMS'])){
	...
	if (!empty($arResult['SKU_PROPS'])){
		$arSkuTemplate=CNextB2c::GetSKUPropsArray($arResult['SKU_PROPS'], $arResult["SKU_IBLOCK_ID"], "block", $arParams["OFFER_HIDE_NAME_PROPS"], "Y");
	}?>
	<script type="text/javascript">
		BX.message({
										...
										<?if(!empty($arItem['OFFERS']) && isset($arSkuTemplate[$arItem['IBLOCK_ID']])){?>
											<?if(!empty($arItem['OFFERS_PROP'])){?>
												<div class="sku_props">
													...
													<?$arItemJSParams=CNextB2c::GetSKUJSParams($arResult, $arParams, $arItem, "N", "Y");?>
