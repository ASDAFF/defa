...
$MESS["AUTH_ONLY_FOR_ARCHITECT"] = "Чтобы получить доступ к разделу вам необходимо быть зарегистрированным как архитектор.<br>
        Для этого при регистрации необходимо поставить чекбокс
    \"Я архитектор\". После регистрации администратор проверит ваш аккаунт и предоставить разрешения вашему аккаунту, обычно проверка выполняется в течение суток.";
?>