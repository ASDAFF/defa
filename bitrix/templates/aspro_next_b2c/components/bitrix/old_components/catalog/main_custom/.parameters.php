<?
	...
	$arTemplateParametersParts[] = array(
		...
		"DETAIL_MODIFICATIONS_TITLE" => Array(
				"NAME" => GetMessage("DETAIL_MODIFICATIONS_TITLE"),
				"TYPE" => "STRING",
				"DEFAULT" => GetMessage("DETAIL_MODIFICATIONS_VALUE"),
				"PARENT" => "DETAIL_SETTINGS",
		),
		"DETAIL_RECOMENDATION_TITLE" => Array(
				"NAME" => GetMessage("DETAIL_RECOMENDATION_TITLE"),
				"TYPE" => "STRING",
				"DEFAULT" => GetMessage("DETAIL_RECOMENDATION_VALUE"),
				"PARENT" => "DETAIL_SETTINGS",
		),
		"STIKERS_PROP" => array(
	...
	[
		'SERIES_LIST_POPULAR_KITS_SORT'=>
		[
			'NAME'=>'Сортировка торговых предложений в блоке "Популярные комплекты" в списке серий',
			'TYPE'=>'LIST',
			'VALUES'=>
			[
				'sort'=>'По индексу сортировки',
				'avail'=>'По наличию на складе в данном регионе',
			],
			'DEFAULT'=>'sort',
		]
	];
    $arTemplateParametersParts[]=
    [
        'SERIES_LIST_COLORS_ADD_PROPS'=>
        [
            'NAME'=>'Коды свойств торговых предложений для вывода в блоке "Дополнительные цвета" в списке серий',
            'TYPE'=>'STRING',
            'MULTIPLE'=>'Y',
        ]
    ];
