...
$arFilterElement = array("IBLOCK_ID" => CNextCacheB2c::$arIBlocks[SITE_ID]["aspro_next_catalog"]["aspro_next_landing"][0], "ACTIVE"=>"Y");
...
{
	$arElement = CNextCacheB2c::CIBLockElement_GetList(array('CACHE' => array("MULTI" =>"N", "TAG" => CNextCacheB2c::GetIBlockCacheTag(CNextCacheB2c::$arIBlocks[SITE_ID]["aspro_next_catalog"]["aspro_next_landing"][0]))), array_merge($arFilterElement, array("ID" => $arResult["VARIABLES"]["ELEMENT_ID"])), false, false, $arSelect);
}
elseif(strlen(trim($arResult["VARIABLES"]["ELEMENT_CODE"])) > 0)
{
	$arElement = CNextCacheB2c::CIBLockElement_GetList(array('CACHE' => array("MULTI" =>"N", "TAG" => CNextCacheB2c::GetIBlockCacheTag(CNextCacheB2c::$arIBlocks[SITE_ID]["aspro_next_catalog"]["aspro_next_landing"][0]))), array_merge($arFilterElement, array("=CODE" => $arResult["VARIABLES"]["ELEMENT_CODE"])), false, false, $arSelect);
