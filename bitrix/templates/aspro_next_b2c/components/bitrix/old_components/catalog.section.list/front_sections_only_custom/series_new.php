                            ...
                            <div class="row">
                                <div class="col-lg-12 select">
                                    <div class="sort-list-wrapper">
                                        <ul class="sort-list">
                                            <li class="sort-item"><a href="" class="sort-link active all">Все серии</a></li>
                                            <li class="sort-item"><a href="" class="sort-link">Хиты продаж</a></li>
                                            <li class="sort-item"><a href="" class="sort-link">Эконом</a></li>
                                            <li class="sort-item"><a href="" class="sort-link">Премиум</a></li>
                                            <li class="sort-item"><a href="" class="sort-link">Классические</a></li>
                                            <li class="sort-item"><a href="" class="sort-link">Итальянские</a></li>
                                        </ul>
                                    </div>
                                    <div class="view-list">
                                            ...
                                            <div class="series-slider-wrapper">
                                                <div class="slick-slider put-arrows main-slide slider-for slider-single">
                                                    <?foreach($arResult['SERIES_GALLERIES'][$arSection['UF_SERIES_GALLERY']] as $image)
                                                    {
                                                        ?>
                                                        <!--                                        <div class="shine">-->
                                                        <a class="series-main-fancy thumb" rel="group" data-fancybox="gallery" href="<?=$image?>">
                                                            <!--                                            <a href="--><?//=$arSection["SECTION_PAGE_URL"]?><!--" class="thumb">-->
                                                            <img class="series-item__main-photo" src="<?=$image?>" alt="" />
                                                        </a>
                                                        <!--                                        </div>-->
                                                        <?
                                                    }
                                                    ...
                                                    <div class="series-item__thumbs slick-nav preview-slide slider-nav">
                                                        <?foreach($arResult['SERIES_GALLERIES'][$arSection['UF_SERIES_GALLERY']] as $image)
                                                        {
                                                            ...
                                                            <div class="series-item__thumb">
                                                                <img class="series-item__thumb-img" src="<?=$image?>" alt="" />
                                                            </div>
                                                            <?
                                                        }
                                                        ?>
...
<!--                                                        --><?//=textCut($arSection['~DESCRIPTION'],200)?>
                                            ...
                                            <div class="series-slider-wrapper">
                                                <div class="slick-slider put-arrows main-slide slider-for-sets slider-single">
                                                    <?foreach($arResult['SERIES_GALLERIES'][$arSection['UF_SERIES_GALLERY']] as $image)
                                                    {
                                                        ?>
                                                        <!--                                        <div class="shine">-->
                                                        <a class="series-main-fancy thumb" rel="group.flag-wrapper" data-fancybox="gallery" href="<?=$image?>">
                                                            <!--                                            <a href="--><?//=$arSection["SECTION_PAGE_URL"]?><!--" class="thumb">-->
                                                            <img class="series-item__main-photo" src="<?=$image?>" alt="" />
                                                        </a>
                                                        <!--                                        </div>-->
                                ...
                                <div class="row series-main projects-block"  data-tab="3">
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="row series-tabs-projects">
                                            <div class="row">
