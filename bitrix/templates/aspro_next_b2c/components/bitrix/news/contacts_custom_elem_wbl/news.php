<? if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED !== true) {
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            ...
            BX.ajax({
                url: '/ajax/wbl/getShop.php?PRODUCT_ID=<?=$arParams['WBL_PRODUCT_ID']?>',
                data: {},
                method: 'POST',
                dataType: 'html',
                timeout: 30,
                ...
                onsuccess: function (data) {
                    document.querySelector('[data-wbl-ajax-place="detail"]').innerHTML = data;
                },
                onfailure: function () {
                }
            });
    ...
    <div class="ajax_items" data-wbl-ajax-place="detail">
    </div>
