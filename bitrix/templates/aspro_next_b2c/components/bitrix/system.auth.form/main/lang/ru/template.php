<?
    ...
    $MESS["AUTH_REQUEST_ACCESS"] = "Запросить доступ";
    $MESS["AUTH_REQUEST_ACCESS"] = "Запросить доступ";
    $MESS["AUTH_REQUEST_ACCESS_TEXT"] = "Чтобы получить доступ к данному разделу нажмите на кнопку \"Запросить доступ\" и отправьте запрос.";
?>