...
<?if($arResult['ITEMS']):?>
	...
	<?endif;?>
			...
			<?foreach($arResult['ITEMS'] as $i => $arItem):?>
				...
				?>
				<div class="news-item <?=($j==1 ? "first-news-item" : "")?>">
					<div class="item shadow slice-item <?=($bImage ? '' : ' wti')?><?=($bActiveDate ? ' wdate' : '')?> <?=($j==1 ? "first-news-item" : "")?>" id="<?=$this->GetEditAreaId($arItem['ID'])?>">
						<?if($bImage):?>
						...
						<div class="body-info">
                            ...
                            <div class="cat-name">
                                <a href="<?SITE_DIR?>company/news">Новости</a>
                            </div>
