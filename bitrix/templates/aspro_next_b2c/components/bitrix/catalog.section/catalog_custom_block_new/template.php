...
>>>>>>> ec0f719dbb9e9f4d463efe179df9ee5da69b58dc
                ...
                <div class="product_delivery">
                    <span>
                        ...
                        <span class="black-text">от 1 дня</span>
                    </span>
                    <span>
                        <div class="delivery_icon">
                ...
                <?if($arItem['PROPERTIES']['PRODUCT_SCHEME']['VALUE']):?>
                    <div class="product_scheme">
                        <img src="<?=CFile::GetPath($arItem['PROPERTIES']['PRODUCT_SCHEME']['VALUE'])?>" alt="product scheme defo.ru" class="product_scheme__img">
                    </div>
                <?endif;?>
