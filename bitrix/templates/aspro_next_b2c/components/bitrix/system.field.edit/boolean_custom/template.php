...
?><div class="fields boolean architect"><?
...
?><input type="hidden" value="0" name="<?=$arParams["arUserField"]["FIELD_NAME"]?>">
				<label><input type="checkbox" value="1" name="<?=$arParams["arUserField"]["FIELD_NAME"]?>" <?=($res ? "checked=\"checked\"": "")?>> <?=\Bitrix\Main\Text\HtmlFilter::encode($arParams["arUserField"]['EDIT_FORM_LABEL'])?> <?if ($arParams["arUserField"]["MANDATORY"] == "Y"):?><span class="star">*</span><?endif;?></label><?
			break;
		}
?></div><?
endforeach;
