...
<div class="header-v13 header-wrapper">
	...
	<div class="logo_and_menu-row">
		<div class="logo-row">
			<div class="maxwidth-theme">
				<div class="row">
					<div class="burger pull-left"><?=CNextB2c::showIconSvg("burger dark", SITE_TEMPLATE_PATH."/images/svg/Burger_big_white.svg");?></div>
					...
					<div class="right-icons pull-right">
						...
						<div class="pull-right block-link">
							<?=CNextB2c::ShowBasketWithCompareLink('with_price', 'big', true, 'wrap_icon inner-table-block baskets');?>
						</div>
						<div class="pull-right">
							<div class="wrap_icon inner-table-block">
								<?=CNextB2c::showCabinetLink(true, true, 'big', true);?>
							</div>
						</div>
						<div class="pull-right">
							<div class="wrap_icon inner-table-block">
								<div class="phone-block">
									<?CNextB2c::ShowHeaderPhones();?>
