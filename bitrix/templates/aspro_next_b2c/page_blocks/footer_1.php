...
<div class="footer_inner <?=($arTheme["SHOW_BG_BLOCK"]["VALUE"] == "Y" ? "fill" : "no_fill");?> footer-light ext_view">
	...
	"bottom", 
	array(
		"ROOT_MENU_TYPE" => "company", //"bottom_info",
		"MENU_CACHE_TYPE" => "A",
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-12 col-sm-4 col-sm-offset-2">
							<div class="info contacts_block_footer">
								...
								<?CNextB2c::ShowHeaderPhones('', true);?>
								<?CNextB2c::showEmail('email blocks');?>
								<?CNextB2c::showAddress('address blocks');?>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12 outer-wrapper">
						<div class="inner-wrapper row">
							<div class="copy-block">
								...
								<div class="print-block"><?=CNextB2c::ShowPrintLink();?></div>
