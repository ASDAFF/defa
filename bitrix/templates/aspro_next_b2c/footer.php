            ...
            <li class="floating-tizer-block drop">
                                        <span class="floating-tizer-link drop" id="callMenu">
                                            <div class="tizer-icon">
                                                <img src="<? SITE_DIR ?>/images/consultant__light.svg" alt="" width="30"
                                                     height="30">
                                            </div>
                ...
                <ul class="hide-tizer" id="hideMenu">
                    ...
                    <!--                                            <li class="floating-tizer-block">-->
                    <!--                                                <span class="animate-load floating-tizer-link" data-event="jqm" data-param-form_id="HELP_ME" data-name="HELP_ME" data-autoload-product_name="-->
					<? //=CNextB2c::formatJsName($arResult["NAME"]);?><!--" data-autoload-product_id="-->
					<? //=$arResult["ID"];?><!--">-->
                    <!--                                                    <div class="tizer-icon">-->
                    <!--                                                        <img src="-->
					<? //SITE_DIR?><!--/images/manager__light.svg" alt="" width="30" height="30">-->
                    <!--                                                    </div>-->
                    <!--                                                    <span>Получить консультацию</span>-->
                    <!--                                                </span>-->
                    <!--                                            </li>-->
                    <!--                                            <li class="floating-tizer-block">-->
                    <!--                                                <span class="animate-load floating-tizer-link" data-event="jqm" data-param-form_id="DESIGN_PROJECT" data-name="DESIGN_PROJECT" data-autoload-product_name="-->
					<? //=CNextB2c::formatJsName($arResult["NAME"]);?><!--" data-autoload-product_id="-->
					<? //=$arResult["ID"];?><!--">-->
                    <!--                                                    <div class="tizer-icon">-->
                    <!--                                                        <img src="-->
					<? //SITE_DIR?><!--/images/design-project__light.svg" alt="" width="30" height="30">-->
                    <!--                                                    </div>-->
                    <!--                                                    <span>Заказать дизайн-проект</span>-->
                    <!--                                                </span>-->
                    <!--                                            </li>-->
                    <li class="floating-tizer-block">
                                                <span class="animate-load floating-tizer-link" data-event="jqm"
                                                      data-param-form_id="CALL_SPECIALIST" data-name="CALL_SPECIALIST"
                                                      data-autoload-product_name="<?=CNextB2c::formatJsName($arResult["NAME"]);?>"
                                                      data-autoload-product_id="<?=$arResult["ID"];?>">
                                                    <div class="tizer-icon">
                                                        <img src="<? SITE_DIR ?>/images/manager-call__light.svg" alt=""
                                                             width="30" height="30">
                                                    </div>
                    ...
                    <!--                                            <li class="floating-tizer-block">-->
                    <!--                                                <span class="animate-load floating-tizer-link" data-event="jqm" data-param-form_id="TEST_DRIVE" data-name="TEST_DRIVE" data-autoload-product_name="-->
					<? //=CNextB2c::formatJsName($arResult["NAME"]);?><!--" data-autoload-product_id="-->
					<? //=$arResult["ID"];?><!--">-->
                    <!--                                                    <div class="tizer-icon">-->
                    <!--                                                        <img src="-->
					<? //SITE_DIR?><!--/images/test_drive__light.svg" alt="" width="30" height="30">-->
                    <!--                                                    </div>-->
                    ...
                    <li class="floating-tizer-block">
                                                <span class="animate-load floating-tizer-link" data-event="jqm"
                                                      data-param-form_id="BOSS_MESSAGE" data-name="BOSS_MESSAGE"
                                                      data-autoload-product_name="<?=CNextB2c::formatJsName($arResult["NAME"]);?>"
                                                      data-autoload-product_id="<?=$arResult["ID"];?>">
                                                    <div class="tizer-icon">
                                                        <img src="<? SITE_DIR ?>/images/mesage_rukovodstvo__light.svg"
                    ...
                    <li class="floating-tizer-block">
                                                <span class="animate-load floating-tizer-link" data-event="jqm"
                                                      data-param-form_id="LEAVE_FEEDBACK" data-name="LEAVE_FEEDBACK"
                                                      data-autoload-product_name="<?=CNextB2c::formatJsName($arResult["NAME"]);?>"
                                                      data-autoload-product_id="<?=$arResult["ID"];?>">
                                                    <div class="tizer-icon">
                                                        <img src="<? SITE_DIR ?>/images/feedback__light.svg" alt=""
                                                             width="30" height="30">
                                                    </div>
...
<div class="gift-banner">
    ...
    <div class="gift-banner__content">
        <h3 class="gift-banner__title">Хотите получить <span class="gift-sale">500 <small>руб.</small></span> на Вашу
            покупку?</h3>
...
<div class="flag-wrapper">
    <div class="flag design">
        <span class="animate-load flag-link" data-event="jqm" data-param-form_id="DESIGN_PROJECT"
              data-name="DESIGN_PROJECT" data-autoload-product_name="<?=CNextB2c::formatJsName($arResult["NAME"]);?>"
              data-autoload-product_id="<?=$arResult["ID"];?>">Дизайн-проект<br> 3D бесплатно</span>
    </div>
    <div class="flag test-drive">
        <span class="animate-load flag-link" data-event="jqm" data-param-form_id="TEST_DRIVE" data-name="TEST_DRIVE"
              data-autoload-product_name="<?=CNextB2c::formatJsName($arResult["NAME"]);?>"
              data-autoload-product_id="<?=$arResult["ID"];?>">Тест-драйв мебели<br> у Вас в офисе</span>
    </div>
    <div class="flag more-quantity">
        <span class="animate-load flag-link" data-event="jqm" data-param-form_id="COMMERCIAL_OFFER"
              data-name="COMMERCIAL_OFFER" data-autoload-product_name="<?=CNextB2c::formatJsName($arResult["NAME"]);?>"
              data-autoload-product_id="<?=$arResult["ID"];?>">Необходимо<br> много мебели?</span>
    </div>
</div>
