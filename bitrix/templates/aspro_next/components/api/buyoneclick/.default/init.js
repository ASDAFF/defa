...
(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-K7L4P4R');
	...
	var methods = {
		...
		init: function (params) {
			...
			if (!this.data('apiBuyoneclick')) {
				...
				$(document).on('click', '.aboc-modal, .aboc-modal-close, .api-close2', function (e) {
					e.preventDefault();
...
// Вставленный код
							...
							yaCounter46266642.reachGoal('buyoneclick');
// конец вставленного кода
                ...
                $(".buyoneclick span").on('click', function () {
                    var data_id = $(this).attr('data-id');
                    var data = $(this).data();
                    $(this).attr('disabled', true);
                    options.arParams.AJAX = 'Y';
                    options.arParams.PRODUCT_ID = data_id;
                    $.ajax({
