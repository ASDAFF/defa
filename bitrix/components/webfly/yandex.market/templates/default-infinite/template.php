...
function getPromos($arResult, $arParams) {
    ...
    if ($arParams['YM_PROMO_GIFT'] == 'Y') {
        $gifts .= '<gifts>';
        foreach ($arResult['PROMO_GIFTS'] as $gift) {
            $gifts .= '<gift id="'.$gift['ID'].'">';
            $gifts .= '<name>'.$gift['NAME'].'</name>';
            $gifts .= '<picture>'.$site_url.$gift['PICTURE'].'</picture>';
            $gifts .= '</gift>';
        }
        $gifts .= '</gifts>';
    }
    ...
    if ($arParams['YM_PROMO_FLASH_DISCOUNT'] == 'Y' || $arParams['YM_PROMO_GIFT'] == 'Y') {
        foreach ($arResult['PROMOS'] as $promo) {
            if (!empty($promo['PRODUCTS'])) {
                $type = 'flash discount';
                if ($promo['TYPE'] == 'GIFTS') $type = 'gift with purchase';

                $promos .= '<promo id="'.$promo['ID'].'" type="'.$type.'">';
                if ($promo['TYPE'] == 'FLASH' && $arParams['YM_PROMO_FLASH_DISCOUNT'] == 'Y') {
                ...
                if ($arParams['YM_PROMO_SHOW_DESC'] == 'Y') {
                    $promos .= '<description>'.htmlspecialchars($promo['PREVIEW_TEXT']).'</description>';
                }
                ...
                $promos .= '</purchase>';
                if ($promo['TYPE'] == 'GIFTS' && $arParams['YM_PROMO_GIFT'] == 'Y') {
                    $promos .= '<promo-gifts>';
                    foreach ($promo['PROPERTIES']['YM_GIFTS']['VALUE'] as $giftID) {
                        $promos .= '<promo-gift gift-id="'.$giftID.'"/>';
                    }
                    foreach ($promo['PROPERTIES']['YM_OFFER_GIFTS']['VALUE'] as $offerGiftID) {
                        $promos .= '<promo-gift offer-id="'.$offerGiftID.'"/>';
                    }
                    $promos .= '</promo-gifts>';
                }
                $promos .= '</promo>';
