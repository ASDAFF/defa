...
<div id="skyweb24_video_youtube">
	...
	*/?>
	...
	console.log('!!!');
			...
			let newCodeNode=document.querySelector('a[name=dinamic_video]'),
				targetFrame=document.querySelector('#skyweb24_video_youtube iframe');
			console.log(newCodeNode.dataset.video)
			targetFrame.src='https://www.youtube.com/embed/'+newCodeNode.dataset.video;
