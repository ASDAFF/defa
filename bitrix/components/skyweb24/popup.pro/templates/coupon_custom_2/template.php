	...
	<div class="bg">
		<div>
			...
			<div class="coupon_block">
                <button onclick="getCouponC<?=$arParams['ID_POPUP']?>();"><?=$arResult['BUTTON_TEXT']?></button>
			...
			<?=bitrix_sessid_post()?>
			<span class="cupon-copy"><?=GetMessage('POPUPPRO_COPYED')?></span>
			</div>
            <p class="attention"><sup>*</sup>Оставляя email, Вы соглашаетесь с условиями <a href="/include/licenses_detail.php">политики конфидициальности</a>.</p>
		</div>
	</div>
</div>
<script>
