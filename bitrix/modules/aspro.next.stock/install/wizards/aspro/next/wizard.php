...
class SelectSiteStep extends CSelectSiteWizardStep{
	function InitStep(){
		...
		$wizard->solutionName = "next.stock";
	}
}
...
class SelectTemplateStep extends CSelectTemplateWizardStep{
	function InitStep(){
		...
		$wizard->SetDefaultVars(Array("templateID" => "next.stock"));
	}
	...
	function ShowStep(){
		if(!CModule::IncludeModule("aspro.next.stock")){
...
class SelectThemeStep extends CSelectThemeWizardStep{
	...
	function ShowStep(){
		...
		$ThemeID = strtolower(COption::GetOptionString("aspro.next.stock", "BASE_COLOR", '9', $siteID));
...
class SiteSettingsStep extends CSiteSettingsWizardStep{
	function InitStep(){
		if(CModule::IncludeModule("aspro.next.stock")){
			...
			$arCurSiteTheme = CNextStock::GetBackParametrsValues($siteID);
...
class FinishStep extends CFinishWizardStep{
	...
	function ShowStep(){
		...
		if(CModule::IncludeModule("aspro.next.stock")){
			CNextStock::newAction("wizard_installed");
		}
		
		COption::SetOptionString("aspro.next.stock", "WIZARD_DEMO_INSTALLED", "Y");
	}
}
?>