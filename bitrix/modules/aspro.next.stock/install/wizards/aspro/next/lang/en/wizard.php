...
$MESS["WIZ_COMPANY_NAME_DEF"] = "Аспро: Next STOCK - интернет-магазин";
$MESS["WIZ_COMPANY_COPY"] = "Подпись сайта:";
$MESS["WIZ_COMPANY_COPY_DEF"] = "Аспро: Next STOCK - интернет-магазин";
...
$MESS["WIZ_SHOP_PRICE_BASE_TEXT1"] = "В решении \"Аспро: Next STOCK - интернет-магазин\" используется в качестве публичных цен для просмотра и покупки базовая цена (BASE). В текущий момент для группы \"Все пользователи (в том числе неавторизованные)\" включено право на данный тип цены. Таким образом данная группа будет видеть цены в решении.";
...
$MESS["WIZ_NO_MODULE_"] = "Не установлен модуль &laquo;Аспро: Next STOCK - интернет-магазин&raquo;. Для продолжения работы мастера <a href='/bitrix/admin/partner_modules.php'>перейдите по ссылке</a> и установите модуль.";
