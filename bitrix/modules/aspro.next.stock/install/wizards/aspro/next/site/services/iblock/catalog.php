...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	{
		$arFields = Array(
			'NAME' => GetMessage('WZD_OPTION_321'),
			'ACTIVE' => 'Y',
			'SORT' => '100',
			'IBLOCK_ID' => $iblockID,
			'CODE' => $codeProp,
	...
	{
		$arFields = Array(
			'NAME' => GetMessage('WZD_OPTION_357'),
			'ACTIVE' => 'Y',
			'SORT' => '100',
			'IBLOCK_ID' => $iblockID,
			'CODE' => $codeProp,
