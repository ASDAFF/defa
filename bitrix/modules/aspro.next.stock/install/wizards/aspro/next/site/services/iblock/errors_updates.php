...
if(isset($_SESSION["NEXT_CATALOG_ID"]) && $_SESSION["NEXT_CATALOG_ID"])
	\Bitrix\Main\Config\Option::set("aspro.next.stock", "CATALOG_IBLOCK_ID", $_SESSION["NEXT_CATALOG_ID"], WIZARD_SITE_ID);
\Bitrix\Main\Config\Option::set("aspro.next.stock", "MAX_DEPTH_MENU", 4, WIZARD_SITE_ID);
\Bitrix\Main\Config\Option::set("aspro.next.stock", "REGIONALITY_FILTER_ITEM", "Y", WIZARD_SITE_ID);

$catalogIBlockID = CNextCacheStock::$arIBlocks[WIZARD_SITE_ID]["aspro_next_catalog"]["aspro_next_catalog"][0];
$landingIBlockID = CNextCacheStock::$arIBlocks[WIZARD_SITE_ID]['aspro_next_catalog']['aspro_next_catalog_info'][0];
$servicesIBlockID = CNextCacheStock::$arIBlocks[WIZARD_SITE_ID]['aspro_next_content']['aspro_next_services'][0];
...
$brandsIBlockID = CNextCacheStock::$arIBlocks[WIZARD_SITE_ID]['aspro_next_content']['aspro_next_brands'][0];
