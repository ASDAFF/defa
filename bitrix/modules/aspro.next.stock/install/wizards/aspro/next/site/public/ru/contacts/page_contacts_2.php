...
$bUseFeedback = CNextStock::GetFrontParametrValue('CONTACTS_USE_FEEDBACK', SITE_ID) != 'N';
?>
...
<div class="contacts maxwidth-theme" itemscope itemtype="http://schema.org/Organization">
	<div class="row">
		<div class="<?=($bUseMap ? 'col-md-4' : 'col-md-12')?>">
			...
			<table>
				<tbody>
					<?CNextStock::showContactAddr('Адрес', false);?>
					<?CNextStock::showContactPhones('Телефон', false);?>
					<?CNextStock::showContactEmail('E-mail', false);?>
					<?CNextStock::showContactSchedule('Режим работы', false);?>
				</tbody>
			</table>
		</div>
		<?if($bUseMap):?>
...
<?if($bUseFeedback):?>
	...
	<?$APPLICATION->IncludeComponent("bitrix:form.result.new", "inline",
		Array(
			...
			"HIDDEN_CAPTCHA" => CNextStock::GetFrontParametrValue('HIDDEN_CAPTCHA'),
			"CHAIN_ITEM_TEXT" => "",
			"CHAIN_ITEM_LINK" => "",
