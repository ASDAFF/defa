...
<?if(isset($_POST["AJAX_REQUEST_INSTAGRAM"]) && $_POST["AJAX_REQUEST_INSTAGRAM"] == "Y"):
	$inst=new CInstargramNextStock($arParams["TOKEN"], \Bitrix\Main\Config\Option::get("aspro.next.stock", "INSTAGRAMM_ITEMS_COUNT", 8));
	...
	if($arInstagramPosts && !$arInstagramPosts["meta"]["error_message"]):?>
		...
		$text_length = \Bitrix\Main\Config\Option::get("aspro.next.stock", "INSTAGRAMM_TEXT_LENGTH", 400);?>
		<div class="item-views front blocks">
			...
			<div class="instagram clearfix">
				<?$iCountSlide = \Bitrix\Main\Config\Option::get("aspro.next.stock", "INSTAGRAMM_ITEMS_VISIBLE", 4);?>
	...
	<?endif;?>
<?else:?>
	<div class="instagram_wrapper wide_<?=\Bitrix\Main\Config\Option::get("aspro.next.stock", "INSTAGRAMM_WIDE_BLOCK", "N");?>">
