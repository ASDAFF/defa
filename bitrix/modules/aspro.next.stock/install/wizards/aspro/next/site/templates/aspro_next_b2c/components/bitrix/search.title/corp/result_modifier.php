...
if (!empty($arResult["ELEMENTS"]) && CModule::IncludeModule("iblock"))
{
	...
	$bHideNotAvailable = (\Bitrix\Main\Config\Option::get('aspro.next.stock', 'SEARCH_HIDE_NOT_AVAILABLE', 'N') == 'Y');
	...
	while($arElement = $rsElements->Fetch())
	{
		...
		if($arOffers){
			...
			$arResult["ELEMENTS"][$arElement["ID"]]["MIN_PRICE"]=CNextStock::getMinPriceFromOffersExt(
					$arOffers,
