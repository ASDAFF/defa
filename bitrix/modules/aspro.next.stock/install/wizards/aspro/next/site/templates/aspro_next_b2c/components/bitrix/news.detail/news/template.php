...
<?if($bShowSales):?>
	...
	<?$APPLICATION->IncludeComponent(
		...
		array(
			...
			"IBLOCK_ID" => CNextCacheStock::$arIBlocks[SITE_ID]["aspro_next_content"]["aspro_next_news"][0],
			"NEWS_COUNT" => "20",
			"SORT_BY1" => "SORT",
			"SORT_ORDER1" => "ASC",
			"SORT_BY2" => "ID",
	...
	<table class="order-block">
		<tr>
			...
			<td class="col-md-3 col-sm-4 col-xs-5 valign">
				<div class="btns">
					<span class="btn btn-default btn-lg animate-load" data-event="jqm" data-param-form_id="<?=($arParams["FORM_ID_ORDER_SERVISE"] ? $arParams["FORM_ID_ORDER_SERVISE"] : 'SERVICES');?>" data-name="order_services" data-autoload-service="<?=CNextStock::formatJsName($arResult['NAME']);?>" data-autoload-project="<?=CNextStock::formatJsName($arResult['NAME']);?>"><span><?=(strlen($arParams['S_ORDER_SERVISE']) ? $arParams['S_ORDER_SERVISE'] : Loc::getMessage('S_ORDER_SERVISE'))?></span></span>
				</div>
			</td>
		</tr>
	</table>
