...
<?else:?>
	<div class="module-enter have-user">
		...
		global $USER;
		$arPhoto=array();
		$arUser=CNextCacheStock::CUser_GetList(array("SORT"=>"ASC", "CACHE" => array("MULTI" => "N", "TAG"=>CNextCacheStock::GetUserCacheTag($USER->GetID()))), array("ID"=>$USER->GetID()), array("FIELDS"=>array("ID", "PERSONAL_PHOTO")));
