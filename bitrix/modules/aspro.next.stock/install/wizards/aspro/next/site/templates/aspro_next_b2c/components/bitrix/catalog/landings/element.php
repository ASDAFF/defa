...
$arFilterElement = array("IBLOCK_ID" => CNextCacheStock::$arIBlocks[SITE_ID]["aspro_next_catalog"]["aspro_next_landing"][0], "ACTIVE"=>"Y");
...
{
	$arElement = CNextCacheStock::CIBLockElement_GetList(array('CACHE' => array("MULTI" =>"N", "TAG" => CNextCacheStock::GetIBlockCacheTag(CNextCacheStock::$arIBlocks[SITE_ID]["aspro_next_catalog"]["aspro_next_landing"][0]))), array_merge($arFilterElement, array("ID" => $arResult["VARIABLES"]["ELEMENT_ID"])), false, false, $arSelect);
}
elseif(strlen(trim($arResult["VARIABLES"]["ELEMENT_CODE"])) > 0)
{
	$arElement = CNextCacheStock::CIBLockElement_GetList(array('CACHE' => array("MULTI" =>"N", "TAG" => CNextCacheStock::GetIBlockCacheTag(CNextCacheStock::$arIBlocks[SITE_ID]["aspro_next_catalog"]["aspro_next_landing"][0]))), array_merge($arFilterElement, array("=CODE" => $arResult["VARIABLES"]["ELEMENT_CODE"])), false, false, $arSelect);
