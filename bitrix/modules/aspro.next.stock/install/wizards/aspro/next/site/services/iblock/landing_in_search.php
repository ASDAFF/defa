...
$iblockEDIT_FILE_AFTER = "/bitrix/modules/aspro.next.stock/admin/iblock/iblock_search_element_edit.php";
$iblockID = false;
...
if(WIZARD_INSTALL_DEMO_DATA){
	if(!$iblockID){
		if($catalogIBlockID = CNextCacheStock::$arIBlocks[WIZARD_SITE_ID]['aspro_next_catalog']['aspro_next_catalog'][0]){
			$vannaSectionID = CNextCacheStock::CIBlockSection_GetList(
				array(
					'CACHE' => array(
						'TAG' => CNextCacheStock::GetIBlockCacheTag($catalogIBlockID),
						'MULTI' => 'N',
						'RESULT' => array('ID'),
					)
				),
			...
			$dreliSectionID = CNextCacheStock::CIBlockSection_GetList(
				array(
					'CACHE' => array(
						'TAG' => CNextCacheStock::GetIBlockCacheTag($catalogIBlockID),
						'MULTI' => 'N',
			...
			$perforatorySectionID = CNextCacheStock::CIBlockSection_GetList(
				array(
					'CACHE' => array(
						'TAG' => CNextCacheStock::GetIBlockCacheTag($catalogIBlockID),
						'MULTI' => 'N',
			...
			$elinstumentsSectionID = CNextCacheStock::CIBlockSection_GetList(
				array(
					'CACHE' => array(
						'TAG' => CNextCacheStock::GetIBlockCacheTag($catalogIBlockID),
						'MULTI' => 'N',
			...
			$akkumSectionID = CNextCacheStock::CIBlockSection_GetList(
				array(
					'CACHE' => array(
						'TAG' => CNextCacheStock::GetIBlockCacheTag($catalogIBlockID),
						'MULTI' => 'N',
