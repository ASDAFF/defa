...
$arFrontParametrs = CNextStock::GetFrontParametrsValues(SITE_ID);
...
// $APPLICATION->AddHeadString(CNextStock::GetBannerStyle($arResult['BANNER_WIDTH']['VALUE'], $arResult['TOP_MENU']['VALUE']), true);
