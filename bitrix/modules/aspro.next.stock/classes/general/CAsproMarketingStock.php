...
class CAsproMarketingB2c{
    const MODULE_ID = \CNextStock::moduleID;
    const LOCAL_DIR_TMPL = "/modules/aspro.next.stock/preset/template/";
    // const LOCAL_DIR_IMG = '/images/'.CNextStock::moduleID.'/preset/template/';
    ...
    public static function replaceTemplateByDefaultData($template){
        ...
        $arModuleOptions = \CNextStock::GetBackParametrsValues($site_id);
        $arThemeValues = array();
        ...
        $bg_color = \CNextStock::$arParametrsList['MAIN']['OPTIONS']['BASE_COLOR']['LIST'][$color_theme]['COLOR'];
