<?
AddEventHandler('main', 'OnBuildGlobalMenu', 'OnBuildGlobalMenuHandlerNextStock');
function OnBuildGlobalMenuHandlerNextStock(&$arGlobalMenu, &$arModuleMenu){
	if(!defined('ASPRO_NEXT_STOCK_MENU_INCLUDED')){
		define('ASPRO_NEXT_STOCK_MENU_INCLUDED', true);
		...
		if($GLOBALS['APPLICATION']->GetGroupRight($moduleID) >= 'R'){
			$arMenu = array(
				'menu_id' => 'global_menu_aspro_next_stock',
				'text' => GetMessage('ASPRO_NEXT_STOCK_GLOBAL_MENU_TEXT'),
				'title' => GetMessage('ASPRO_NEXT_STOCK_GLOBAL_MENU_TITLE'),
				'sort' => 1000,
				'items_id' => 'global_menu_aspro_next_stock_items',
				'icon' => 'imi_next',
				'items' => array(
					array(
