...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	$servicesIBlockID = $iblockID;
	$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $servicesIBlockID, "CODE" => "LINK_GOODS_FILTER"));
	if(!$dbProperty->SelectedRowsCount())
	{
		$ibp = new CIBlockProperty;
		$arFields = Array(
			"NAME" => GetMessage("WZD_OPTION_358"),
			"ACTIVE" => "Y",
			"SORT" => "100",
