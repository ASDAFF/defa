...
// replace macros SITE_DIR & SITE_ID & SITE_TEMPLATE_PATH
...
CWizardUtil::ReplaceMacros($bitrixTemplateDir."snippets/snippet0007.snp", Array("SITE_TEMPLATE_PATH" => $bitrixTemplatePath));
CWizardUtil::ReplaceMacros($bitrixTemplateDir."snippets/snippet0008.snp", Array("SITE_TEMPLATE_PATH" => $bitrixTemplatePath));
