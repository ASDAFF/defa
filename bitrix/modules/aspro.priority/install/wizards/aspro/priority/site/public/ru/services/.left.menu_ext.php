...
if($arMenuParametrs = CPriority::GetDirMenuParametrs(__DIR__)){
	...
	if($arSections){
		CPriority::getSectionChilds(false, $arSections, $arSectionsByParentSectionID, $arItemsBySectionID, $aMenuLinksExt, CCache::$arIBlocks[SITE_ID]['aspro_priority_catalog']['aspro_priority_services'][0]);
	}
