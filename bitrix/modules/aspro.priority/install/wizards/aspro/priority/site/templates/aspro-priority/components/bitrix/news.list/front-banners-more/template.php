...
<?if($arResult['ITEMS']):?>
	...
	{
		$total_count = $arResult['NAV_RESULT']->NavRecordCount;
		if($total_count > 3 && ($total_count - $qntyItems) > 3 && $arParams['NEWS_COUNT'] > 3)
		{
			$colmd = 3;
			$colsm = 12;
		}
		...
		<div class="maxwidth-theme">
			<div class="col-md-12">
				<div class="banners-small front">
					<div class="items row" data-colsm="<?=$data_colsm?>" data-colmd="<?=$data_colmd?>">
	<?endif;?>
