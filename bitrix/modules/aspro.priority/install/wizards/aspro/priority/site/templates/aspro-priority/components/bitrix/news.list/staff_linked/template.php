	...
	<div class="item-views staff linked sections">
		<div class="row">
			<div class="col-md-12">
				...
				?>
				<div class="flexslider unstyled row front" data-plugin-options='{"smootHeight": true, "directionNav": true, "controlNav" :false, "animationLoop": true, "slideshow": false, <?=($slideshowSpeed >= 0 ? '"slideshowSpeed": '.$slideshowSpeed.',' : '')?> <?=($animationSpeed >= 0 ? '"animationSpeed": '.$animationSpeed.',' : '')?> "itemMargin": 32, "counts": [3, 2, 2, 1]}'>
					<ul class="slides items row">
						<?foreach($arResult['ITEMS'] as $i => $arItem):?>
							...
							?>
							<li class="item col-md-4 colsm-6" data-id="<?=$arItem['ID'];?>">
