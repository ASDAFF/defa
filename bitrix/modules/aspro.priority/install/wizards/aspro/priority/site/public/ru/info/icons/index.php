...
<div class="row">
	<div class="col-md-6">
		<h4 class="spaced">.icon-text + text</h4>
		<p>
	...
	<div class="col-md-6">
		<h4 class="spaced">.icon-text.grey + text</h4>
		<p>
	...
	<div class="icons-list">
		<div class="col-md-12">
			<section id="web-application">
				<h2 class="spaced">40 New Icons in 4.3</h2>
			...
			<section id="web-application">
				<h2 class="page-header spaced">Web Application Icons</h2>
				<div class="row fontawesome-icon-list">
			...
			<section id="transportation">
				<h2 class="spaced page-header">Transportation Icons</h2>
				<div class="row fontawesome-icon-list">
			...
			<section id="gender">
				<h2 class="spaced page-header">Gender Icons</h2>
				<div class="row fontawesome-icon-list">
					<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-circle-thin"></i> circle-thin</div>
					<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-genderless"></i> genderless <span class="text-muted">(alias)</span></div>
					<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mars"></i> mars</div>
			...
			<section id="file-type">
				<h2 class="spaced page-header">File Type Icons</h2>
				<div class="row fontawesome-icon-list">
			...
			<section id="spinner">
				<h2 class="spaced page-header">Spinner Icons</h2>
			...
			<section id="form-control">
				<h2 class="spaced page-header">Form Control Icons</h2>
				<div class="row fontawesome-icon-list">
					<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-check-square"></i> check-square</div>
					<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-check-square-o"></i> check-square-o</div>
					<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-circle"></i> circle</div>
			...
			<section id="payment">
				<h2 class="spaced page-header">Payment Icons</h2>
				<div class="row fontawesome-icon-list">
			...
			<section id="chart">
				<h2 class="spaced page-header">Chart Icons</h2>
				<div class="row fontawesome-icon-list">
					<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-area-chart"></i> area-chart</div>
					<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bar-chart"></i> bar-chart</div>
					<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bar-chart-o"></i> bar-chart-o <span class="text-muted">(alias)</span></div>
			...
			<section id="currency">
				<h2 class="spaced page-header">Currency Icons</h2>
				<div class="row fontawesome-icon-list">
			...
			<section id="text-editor">
				<h2 class="spaced page-header">Text Editor Icons</h2>
				<div class="row fontawesome-icon-list">
			...
			<section id="directional">
				<h2 class="spaced page-header">Directional Icons</h2>
				<div class="row fontawesome-icon-list">
			...
			<section id="video-player">
				<h2 class="spaced page-header">Video Player Icons</h2>
				<div class="row fontawesome-icon-list">
					<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrows-alt"></i> arrows-alt</div>
			...
			<section id="brand">
				<h2 class="spaced page-header">Brand Icons</h2>
			...
			<section id="medical">
				<h2 class="spaced page-header">Medical Icons</h2>
				<div class="row fontawesome-icon-list">
					<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ambulance"></i> ambulance</div>
