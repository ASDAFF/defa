		...
		if($bHasSection)
		{
			...
			<div class="items row">
				...
				<?foreach($arResult['ITEMS'] as $i => $arItem):?>
					...
					?>
					<div class="item clearfix<?=($bBigBlock ? ' big_block' : '')?><?=(!$bImage ? ' wti' : '')?><?=($textColor ? ' '.$textColor : '')?> col-md-<?=($bBigBlock ? 6 : 3)?> col-sm-4 col-xs-6 s-<?=$arItem['IBLOCK_SECTION_ID'];?>" data-ref="mixitup-target">
