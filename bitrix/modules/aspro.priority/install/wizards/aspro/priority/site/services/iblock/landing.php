...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	unset($ibp);
	$ibp = new CIBlockProperty;
	$ibp->Update($arProperty["FILTER_URL"], array("HINT" => GetMessage("WZD_PROPERTY_HINT_9")));
	unset($ibp);

	// edit form user options
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_106").'--,--ID--#--'.GetMessage("WZD_OPTION_362").'--,--DATE_CREATE--#--'.GetMessage("WZD_OPTION_364").'--,--TIMESTAMP_X--#--'.GetMessage("WZD_OPTION_366").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_4").'--,--ACTIVE_TO--#--'.GetMessage("WZD_OPTION_6").'--,--NAME--#--'.GetMessage("WZD_OPTION_8").'--,--CODE--#--'.GetMessage("WZD_OPTION_10").'--,--SORT--#--'.GetMessage("WZD_OPTION_12").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_14").'--,--PROPERTY_'.$arProperty["SECTION"].'--#--'.GetMessage("WZD_OPTION_420").'--,--PROPERTY_'.$arProperty["FILTER_URL"].'--#--'.GetMessage("WZD_OPTION_422").'--,--PROPERTY_'.$arProperty["FORM_QUESTION"].'--#--'.GetMessage("WZD_OPTION_416").'--,--PROPERTY_'.$arProperty["H3_GOODS"].'--#--'.GetMessage("WZD_OPTION_424").'--;--edit5--#--'.GetMessage("WZD_OPTION_42").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_228").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_46").'--;--edit6--#--'.GetMessage("WZD_OPTION_48").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_52").'--,--PROPERTY_'.$arProperty["SEO_TEXT"].'--#--'.GetMessage("WZD_OPTION_418").'--;--cedit1--#--'.GetMessage("WZD_OPTION_0").'--,--PROPERTY_'.$arProperty["BNR_TOP"].'--#--'.GetMessage("WZD_OPTION_232").'--,--PROPERTY_'.$arProperty["BNR_TOP_IMG"].'--#--'.GetMessage("WZD_OPTION_44").'--,--PROPERTY_'.$arProperty["BNR_TOP_BG"].'--#--'.GetMessage("WZD_OPTION_50").'--,--PROPERTY_'.$arProperty["BUTTON_TEXT"].'--#--'.GetMessage("WZD_OPTION_426").'--,--PROPERTY_'.$arProperty["BUTTONCLASS"].'--#--'.GetMessage("WZD_OPTION_428").'--,--PROPERTY_'.$arProperty["ANONS"].'--#--'.GetMessage("WZD_OPTION_430").'--,--PROPERTY_'.$arProperty["CODE_TEXT"].'--#--'.GetMessage("WZD_OPTION_22").'--,--PROPERTY_'.$arProperty["BANNER_IMG_ANIMATION"].'--#--'.GetMessage("WZD_OPTION_236").'--;--edit14--#--'.GetMessage("WZD_OPTION_78").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_TITLE--#--'.GetMessage("WZD_OPTION_80").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_KEYWORDS--#--'.GetMessage("WZD_OPTION_82").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_DESCRIPTION--#--'.GetMessage("WZD_OPTION_84").'--,--IPROPERTY_TEMPLATES_ELEMENT_PAGE_TITLE--#--'.GetMessage("WZD_OPTION_86").'--,--IPROPERTY_TEMPLATES_ELEMENTS_PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_88").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_ALT--#--'.GetMessage("WZD_OPTION_90").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_TITLE--#--'.GetMessage("WZD_OPTION_92").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_NAME--#--'.GetMessage("WZD_OPTION_94").'--,--IPROPERTY_TEMPLATES_ELEMENTS_DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_96").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_ALT--#--'.GetMessage("WZD_OPTION_90").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_TITLE--#--'.GetMessage("WZD_OPTION_92").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_NAME--#--'.GetMessage("WZD_OPTION_94").'--,--SEO_ADDITIONAL--#--'.GetMessage("WZD_OPTION_98").'--,--TAGS--#--'.GetMessage("WZD_OPTION_100").'--;--edit2--#--'.GetMessage("WZD_OPTION_102").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_102").'--;----#--'.GetMessage("WZD_OPTION_104").'--;--',
	));
	// list user options
