...
$dbHblock = HL\HighloadBlockTable::getList(array("filter" => array("NAME" => "AsproPriorityProfitReference")));
if(!$dbHblock->Fetch()){
	$data = array('NAME' => 'AsproPriorityProfitReference', 'TABLE_NAME' => 'priority_profit_reference');
	$result = HL\HighloadBlockTable::add($data);
	$HL_ID = $result->getId();
	$_SESSION["PRIORITY_HBLOCK_TIZERS_ID"] = $HL_ID;
