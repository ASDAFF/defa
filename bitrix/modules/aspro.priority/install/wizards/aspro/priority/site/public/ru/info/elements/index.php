	...
	<div class="col-md-6">
		...
		<div class="tabs">
			<ul class="nav nav-tabs">
				<li class="font_upper_md active shadow border"><a href="#popularPosts" data-toggle="tab">Popular</a></li>
				<li class="font_upper_md shadow border"><a href="#recentPosts" data-toggle="tab">Recent</a></li>
			</ul>
...
<div class="row">
	<div class="col-md-12">
		<h2 class="spaced short">Accordion type 1</h2>					
...
<div class="row">	
	<div class="col-md-12">
		<h2 class="spaced short">Accordion type 2</h2>
...
<hr class="tall" />
<div class="row">
	<div class="form form_test col-md-6">
		...
		<table class="order-block">
			<tr class="row1">
				...
				<td class="col-md-3 col-sm-4 col-xs-5 valign1">
					<div class="btns">
						<span class="btn btn-default btn-lg" data-event="jqm" data-param-id="<?=CCache::$arIBlocks[SITE_ID]['aspro_priority_form']['aspro_priority_example'][0]?>" data-name="example" data-autoload-STRING="Автозаполнение строки">Пример формы</span>
					</div>
				</td>
			</tr>
		</table>
...
@media (max-width:991px){
	h2:not(.short){margin-top:40px!important;}
	.row:first-of-type .col-md-6:first-of-type h2:not(.short){margin-top:0!important;}
}
</style>
