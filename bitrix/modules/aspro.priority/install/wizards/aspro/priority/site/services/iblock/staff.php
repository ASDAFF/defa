...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_134").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_4").'--,--ACTIVE_TO--#--'.GetMessage("WZD_OPTION_6").'--,--NAME--#--'.GetMessage("WZD_OPTION_135").'--,--CODE--#--'.GetMessage("WZD_OPTION_11").'--,--SORT--#--'.GetMessage("WZD_OPTION_12").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_14").'--,--PROPERTY_'.$arProperty["LINK_REGION"].'--#--'.GetMessage("WZD_OPTION_40").'--,--PROPERTY_'.$arProperty["SEND_MESSAGE_BUTTON"].'--#--'.GetMessage("WZD_OPTION_136").'--,--PROPERTY_'.$arProperty["EMAIL"].'--#--'.GetMessage("WZD_OPTION_138").'--,--PROPERTY_'.$arProperty["POST"].'--#--'.GetMessage("WZD_OPTION_140").'--,--PROPERTY_'.$arProperty["PHONE"].'--#--'.GetMessage("WZD_OPTION_142").'--,--edit1_csection1--#--'.GetMessage("WZD_OPTION_144").'--,--PROPERTY_'.$arProperty["SOCIAL_BITRIX"].'--#--'.GetMessage("WZD_OPTION_146").'--,--PROPERTY_'.$arProperty["SOCIAL_FB"].'--#--'.GetMessage("WZD_OPTION_148").'--,--PROPERTY_'.$arProperty["SOCIAL_GOOGLE"].'--#--'.GetMessage("WZD_OPTION_150").'--,--PROPERTY_'.$arProperty["SOCIAL_INST"].'--#--'.GetMessage("WZD_OPTION_152").'--,--PROPERTY_'.$arProperty["SOCIAL_MAIL"].'--#--'.GetMessage("WZD_OPTION_154").'--,--PROPERTY_'.$arProperty["SOCIAL_SKYPE"].'--#--'.GetMessage("WZD_OPTION_156").'--,--PROPERTY_'.$arProperty["SOCIAL_TW"].'--#--'.GetMessage("WZD_OPTION_158").'--,--PROPERTY_'.$arProperty["SOCIAL_VK"].'--#--'.GetMessage("WZD_OPTION_160").'--,--PROPERTY_'.$arProperty["SOCIAL_ODN"].'--#--'.GetMessage("WZD_OPTION_162").'--;--edit5--#--'.GetMessage("WZD_OPTION_164").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_166").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_46").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_52").'--;--cedit2--#--'.GetMessage("WZD_OPTION_168").'--,--PROPERTY_'.$arProperty["LINK_SALE"].'--#--'.GetMessage("WZD_OPTION_170").'--,--PROPERTY_'.$arProperty["LINK_REVIEWS"].'--#--'.GetMessage("WZD_OPTION_172").'--,--PROPERTY_'.$arProperty["LINK_PROJECTS"].'--#--'.GetMessage("WZD_OPTION_174").'--,--PROPERTY_'.$arProperty["LINK_SERVICES"].'--#--'.GetMessage("WZD_OPTION_176").'--;--edit14--#--'.GetMessage("WZD_OPTION_78").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_TITLE--#--'.GetMessage("WZD_OPTION_80").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_KEYWORDS--#--'.GetMessage("WZD_OPTION_82").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_DESCRIPTION--#--'.GetMessage("WZD_OPTION_84").'--,--IPROPERTY_TEMPLATES_ELEMENT_PAGE_TITLE--#--'.GetMessage("WZD_OPTION_86").'--,--IPROPERTY_TEMPLATES_ELEMENTS_PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_88").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_ALT--#--'.GetMessage("WZD_OPTION_90").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_TITLE--#--'.GetMessage("WZD_OPTION_92").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_NAME--#--'.GetMessage("WZD_OPTION_94").'--,--IPROPERTY_TEMPLATES_ELEMENTS_DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_96").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_ALT--#--'.GetMessage("WZD_OPTION_90").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_TITLE--#--'.GetMessage("WZD_OPTION_92").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_NAME--#--'.GetMessage("WZD_OPTION_94").'--,--SEO_ADDITIONAL--#--'.GetMessage("WZD_OPTION_98").'--,--TAGS--#--'.GetMessage("WZD_OPTION_100").'--;--edit2--#--'.GetMessage("WZD_OPTION_102").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_102").'--;----#--'.GetMessage("WZD_OPTION_104").'--;--',
	));
	// list user options
	CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
		'columns' => 'NAME,ACTIVE,PREVIEW_PICTURE,PROPERTY_'.$arProperty["POST"].',PROPERTY_'.$arProperty["PHONE"].',PROPERTY_'.$arProperty["EMAIL"].',SORT,ID,PROPERTY_'.$arProperty["LINK_REGION"].'', 'by' => 'timestamp_x', 'order' => 'desc', 'page_size' => '20',
	));
}
