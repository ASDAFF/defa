...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_282").'--,--ID--#--'.GetMessage("WZD_OPTION_362").'--,--DATE_CREATE--#--'.GetMessage("WZD_OPTION_364").'--,--TIMESTAMP_X--#--'.GetMessage("WZD_OPTION_366").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_4").'--,--ACTIVE_TO--#--'.GetMessage("WZD_OPTION_6").'--,--NAME--#--'.GetMessage("WZD_OPTION_8").'--,--CODE--#--'.GetMessage("WZD_OPTION_10").'--,--SORT--#--'.GetMessage("WZD_OPTION_12").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_14").'--,--PROPERTY_'.$arProperty["FORM_ORDER"].'--#--'.GetMessage("WZD_OPTION_286").'--,--PROPERTY_'.$arProperty["SHOW_ON_INDEX_PAGE"].'--#--'.GetMessage("WZD_OPTION_128").'--,--PROPERTY_'.$arProperty["HIT"].'--#--'.GetMessage("WZD_OPTION_294").'--,--PROPERTY_'.$arProperty["TURN"].'--#--'.GetMessage("WZD_OPTION_434").'--,--PROPERTY_'.$arProperty["VISA"].'--#--'.GetMessage("WZD_OPTION_436").'--,--Master Card--#--'.GetMessage("WZD_OPTION_104").'--,--ÌÈÐ--#--'.GetMessage("WZD_OPTION_104").'--,--PROPERTY_'.$arProperty["APPLE"].'--#--'.GetMessage("WZD_OPTION_438").'--,--Android Pay--#--'.GetMessage("WZD_OPTION_104").'--,--PROPERTY_'.$arProperty["ELPURSE"].'--#--'.GetMessage("WZD_OPTION_440").'--,--PROPERTY_'.$arProperty["DURATION"].'--#--'.GetMessage("WZD_OPTION_442").'--,--PROPERTY_'.$arProperty["SUPPORT"].'--#--'.GetMessage("WZD_OPTION_444").'--,--PROPERTY_'.$arProperty["NOTIFICATION"].'--#--'.GetMessage("WZD_OPTION_446").'--,--PROPERTY_'.$arProperty["API_INTEGRATION"].'--#--'.GetMessage("WZD_OPTION_448").'--,--PROPERTY_'.$arProperty["SIEM_SYSTEM"].'--#--'.GetMessage("WZD_OPTION_450").'--,--PROPERTY_'.$arProperty["COLLECT_INFO"].'--#--'.GetMessage("WZD_OPTION_452").'--,--PROPERTY_'.$arProperty["RULES_SIGNAT"].'--#--'.GetMessage("WZD_OPTION_454").'--,--PROPERTY_'.$arProperty["NUM_DEVICES"].'--#--'.GetMessage("WZD_OPTION_456").'--,--PROPERTY_'.$arProperty["SCANNER"].'--#--'.GetMessage("WZD_OPTION_458").'--,--PROPERTY_'.$arProperty["ANTIVIRUS"].'--#--'.GetMessage("WZD_OPTION_460").'--,--PROPERTY_'.$arProperty["PROTECT_PAYMENT"].'--#--'.GetMessage("WZD_OPTION_462").'--,--PROPERTY_'.$arProperty["PROTECT_CAMERA"].'--#--'.GetMessage("WZD_OPTION_464").'--,--PROPERTY_'.$arProperty["CONTROL"].'--#--'.GetMessage("WZD_OPTION_466").'--,--PROPERTY_'.$arProperty["SUPPORT_FREE"].'--#--'.GetMessage("WZD_OPTION_468").'--,--PROPERTY_'.$arProperty["GUARANTEE"].'--#--'.GetMessage("WZD_OPTION_470").'--,--PROPERTY_'.$arProperty["BLOCKING_SITES"].'--#--'.GetMessage("WZD_OPTION_472").'--,--PROPERTY_'.$arProperty["BLOCKING_TRAFFIC"].'--#--'.GetMessage("WZD_OPTION_474").'--,--PROPERTY_'.$arProperty["SECURITY"].'--#--'.GetMessage("WZD_OPTION_476").'--,--PROPERTY_'.$arProperty["ANTIVOR"].'--#--'.GetMessage("WZD_OPTION_478").'--,--PROPERTY_'.$arProperty["SUM_FINANCING"].'--#--'.GetMessage("WZD_OPTION_480").'--,--PROPERTY_'.$arProperty["TERM_LEASING"].'--#--'.GetMessage("WZD_OPTION_482").'--,--PROPERTY_'.$arProperty["INSURANCE"].'--#--'.GetMessage("WZD_OPTION_484").'--,--PROPERTY_'.$arProperty["CURRENCY"].'--#--'.GetMessage("WZD_OPTION_486").'--,--PROPERTY_'.$arProperty["ADVANCE_PAY"].'--#--'.GetMessage("WZD_OPTION_488").'--,--PROPERTY_'.$arProperty["RATE"].'--#--'.GetMessage("WZD_OPTION_490").'--,--PROPERTY_'.$arProperty["PERCENTAGE"].'--#--'.GetMessage("WZD_OPTION_492").'--,--PROPERTY_'.$arProperty["PAYMENTS"].'--#--'.GetMessage("WZD_OPTION_494").'--;--edit5--#--'.GetMessage("WZD_OPTION_42").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_228").'--,--PROPERTY_'.$arProperty["ICON"].'--#--'.GetMessage("WZD_OPTION_124").'--,--PROPERTY_'.$arProperty["BACKGROUND"].'--#--'.GetMessage("WZD_OPTION_496").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_46").'--;--cedit1--#--'.GetMessage("WZD_OPTION_498").'--,--PROPERTY_'.$arProperty["TARIF_PRICE_1"].'--#--'.GetMessage("WZD_OPTION_500").'--,--PROPERTY_'.$arProperty["TARIF_PRICE_2"].'--#--'.GetMessage("WZD_OPTION_502").'--,--PROPERTY_'.$arProperty["TARIF_PRICE_3"].'--#--'.GetMessage("WZD_OPTION_504").'--,--PROPERTY_'.$arProperty["TARIF_PRICE_DEFAULT"].'--#--'.GetMessage("WZD_OPTION_506").'--,--PROPERTY_'.$arProperty["ONLY_ONE_PRICE"].'--#--'.GetMessage("WZD_OPTION_508").'--;--edit14--#--'.GetMessage("WZD_OPTION_78").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_TITLE--#--'.GetMessage("WZD_OPTION_80").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_KEYWORDS--#--'.GetMessage("WZD_OPTION_82").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_DESCRIPTION--#--'.GetMessage("WZD_OPTION_84").'--,--IPROPERTY_TEMPLATES_ELEMENT_PAGE_TITLE--#--'.GetMessage("WZD_OPTION_86").'--,--IPROPERTY_TEMPLATES_ELEMENTS_PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_88").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_ALT--#--'.GetMessage("WZD_OPTION_90").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_TITLE--#--'.GetMessage("WZD_OPTION_92").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_NAME--#--'.GetMessage("WZD_OPTION_94").'--,--IPROPERTY_TEMPLATES_ELEMENTS_DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_96").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_ALT--#--'.GetMessage("WZD_OPTION_90").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_TITLE--#--'.GetMessage("WZD_OPTION_92").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_NAME--#--'.GetMessage("WZD_OPTION_94").'--,--SEO_ADDITIONAL--#--'.GetMessage("WZD_OPTION_98").'--,--TAGS--#--'.GetMessage("WZD_OPTION_100").'--;--edit2--#--'.GetMessage("WZD_OPTION_102").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_102").'--;--cedit2--#--'.GetMessage("WZD_OPTION_358").'--,--PROPERTY_'.$arProperty["FILTER_PRICE_1"].'--#--'.GetMessage("WZD_OPTION_510").'--,--PROPERTY_'.$arProperty["FILTER_PRICE_2"].'--#--'.GetMessage("WZD_OPTION_512").'--,--PROPERTY_'.$arProperty["FILTER_PRICE_3"].'--#--'.GetMessage("WZD_OPTION_514").'--,--PROPERTY_'.$arProperty["FILTER_PRICE_DEFAULT"].'--#--'.GetMessage("WZD_OPTION_516").'--;----#--'.GetMessage("WZD_OPTION_104").'--;--',
	));
	// list user options
