								...
								<?if($bOrderButton):?>
									...
									<?if($bOrderButton && !$bOrderViewBasket):?>
										<div class="col-md-3 col-sm-3">
											<div class="button">
												<span class="btn btn-default pull-right animate-load" data-event="jqm" data-param-id="<?=CCache::$arIBlocks[SITE_ID]['aspro_priority_form']['aspro_priority_order_product'][0]?>" data-autoload-product="<?=$arItem['NAME']?>" data-name="order_product"><?=(strlen($arParams['S_ORDER_PRODUCT']) ? $arParams['S_ORDER_PRODUCT'] : GetMessage('S_ORDER_PRODUCT'))?></span>
											</div>
										</div>
