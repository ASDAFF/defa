...
//***********************************
$subscibePage = (isset($arTheme['SUBSCRIBE_PAGE']['VALUE']) && $arTheme['SUBSCRIBE_PAGE']['VALUE'] ? $arTheme['SUBSCRIBE_PAGE']['VALUE'] : $arTheme['SUBSCRIBE_PAGE']);
?>
<div class="status-block top-form">
	<h4><?echo GetMessage("subscr_title_status")?></h4>
	<form action="<?=$subscibePage;?>" method="get">
		<div class="row">
	...
	<?if($arResult["SUBSCRIPTION"]["CONFIRMED"] == "Y"):?>	
		<div class="button-block">
			<?if($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y"):?>
				<input type="submit" class="btn btn-default" name="unsubscribe" value="<?echo GetMessage("subscr_unsubscr")?>" />
				<input type="hidden" name="action" value="unsubscribe" />
			<?else:?>
				<input type="submit" class="btn btn-default" name="activate" value="<?echo GetMessage("subscr_activate")?>" />
