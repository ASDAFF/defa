...
$FORM_SID = "aspro_priority_callback_".WIZARD_SITE_ID;
...
$by = "id"; $order = "asc";
$arFields = array("ACTIVE" => "Y", "EVENT_NAME" => "FORM_FILLING_".$FORM_SID, "LID" => WIZARD_SITE_ID, "EMAIL_FROM" => $wizard->GetVar("siteEmail"), "EMAIL_TO" => "#EMAIL#", "SUBJECT" => GetMessage("NEW_CALLBACK_EMAIL_SUBJECT"), "MESSAGE" => GetMessage("NEW_CALLBACK_EMAIL_TEXT"), "BODY_TYPE" => "html");
