...
class CAsproMarketingB2c{
    ...
    const LOCAL_DIR_TMPL = "/modules/aspro.next.b2c/preset/template/";
    // const LOCAL_DIR_IMG = '/images/'.CNextB2c::moduleID.'/preset/template/';
    ...
    public static function replaceTemplateByDefaultData($template){
        ...
        $arModuleOptions = \CNextB2c::GetBackParametrsValues($site_id);
        $arThemeValues = array();
        ...
        $bg_color = \CNextB2c::$arParametrsList['MAIN']['OPTIONS']['BASE_COLOR']['LIST'][$color_theme]['COLOR'];
