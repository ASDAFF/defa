<?
AddEventHandler('main', 'OnBuildGlobalMenu', 'OnBuildGlobalMenuHandlerNextB2C');
function OnBuildGlobalMenuHandlerNextB2C(&$arGlobalMenu, &$arModuleMenu){
	if(!defined('ASPRO_NEXT_B2C_MENU_INCLUDED')){
		define('ASPRO_NEXT_B2C_MENU_INCLUDED', true);
		...
		if($GLOBALS['APPLICATION']->GetGroupRight($moduleID) >= 'R'){
			$arMenu = array(
				'menu_id' => 'global_menu_aspro_next_b2c',
				'text' => GetMessage('ASPRO_NEXT_B2C_GLOBAL_MENU_TEXT'),
				'title' => GetMessage('ASPRO_NEXT_B2C_GLOBAL_MENU_TITLE'),
				'sort' => 1000,
				'items_id' => 'global_menu_aspro_next_b2c_items',
				'icon' => 'imi_next',
				'items' => array(
					array(
