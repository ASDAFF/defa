...
$arFrontParametrs = CNextB2c::GetFrontParametrsValues(SITE_ID);
...
// $APPLICATION->AddHeadString(CNextB2c::GetBannerStyle($arResult['BANNER_WIDTH']['VALUE'], $arResult['TOP_MENU']['VALUE']), true);
