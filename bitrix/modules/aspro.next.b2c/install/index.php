...
class aspro_next_b2c extends CModule {
	const solutionName	= 'next.b2c';
	const partnerName = 'aspro';
	const moduleClass = 'CNextB2c';
	const moduleClassEvents = 'CNextEventsB2c';
	const moduleClassCache = 'CNextCacheB2c';

	var $MODULE_ID = "aspro.next.b2c";
	var $MODULE_VERSION;
	...
	function DoInstall(){
		...
		$APPLICATION->IncludeAdminFile(GetMessage("ASPRO_NEXT_SCOM_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/aspro.next.b2c/install/step.php");
	}
	...
	function DoUninstall(){
		...
		$APPLICATION->IncludeAdminFile(GetMessage("ASPRO_NEXT_SCOM_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/aspro.next.b2c/install/unstep.php");
	}
}
?>