...
class SelectTemplateStep extends CSelectTemplateWizardStep{
	function InitStep(){
		...
		$wizard->SetDefaultVars(Array("templateID" => "next.b2c"));
	}
	...
	function ShowStep(){
		if(!CModule::IncludeModule("aspro.next.b2c")){
...
class SelectThemeStep extends CSelectThemeWizardStep{
	...
	function ShowStep(){
		...
		$ThemeID = strtolower(COption::GetOptionString("aspro.next.b2c", "BASE_COLOR", '9', $siteID));
...
class SiteSettingsStep extends CSiteSettingsWizardStep{
	function InitStep(){
		if(CModule::IncludeModule("aspro.next.b2c")){
			...
			$arCurSiteTheme = CNextB2c::GetBackParametrsValues($siteID);
...
class FinishStep extends CFinishWizardStep{
	...
	function ShowStep(){
		...
		if(CModule::IncludeModule("aspro.next.b2c")){
			CNextB2c::newAction("wizard_installed");
		}
		
		COption::SetOptionString("aspro.next.b2c", "WIZARD_DEMO_INSTALLED", "Y");
	}
}
?>