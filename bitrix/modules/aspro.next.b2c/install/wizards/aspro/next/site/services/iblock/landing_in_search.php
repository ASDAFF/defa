...
$iblockEDIT_FILE_AFTER = "/bitrix/modules/aspro.next.b2c/admin/iblock/iblock_search_element_edit.php";
$iblockID = false;
...
if(WIZARD_INSTALL_DEMO_DATA){
	if(!$iblockID){
		if($catalogIBlockID = CNextCacheB2c::$arIBlocks[WIZARD_SITE_ID]['aspro_next_catalog']['aspro_next_catalog'][0]){
			$vannaSectionID = CNextCacheB2c::CIBlockSection_GetList(
				array(
					'CACHE' => array(
						'TAG' => CNextCacheB2c::GetIBlockCacheTag($catalogIBlockID),
						'MULTI' => 'N',
						'RESULT' => array('ID'),
					)
				),
			...
			$dreliSectionID = CNextCacheB2c::CIBlockSection_GetList(
				array(
					'CACHE' => array(
						'TAG' => CNextCacheB2c::GetIBlockCacheTag($catalogIBlockID),
						'MULTI' => 'N',
			...
			$perforatorySectionID = CNextCacheB2c::CIBlockSection_GetList(
				array(
					'CACHE' => array(
						'TAG' => CNextCacheB2c::GetIBlockCacheTag($catalogIBlockID),
						'MULTI' => 'N',
			...
			$elinstumentsSectionID = CNextCacheB2c::CIBlockSection_GetList(
				array(
					'CACHE' => array(
						'TAG' => CNextCacheB2c::GetIBlockCacheTag($catalogIBlockID),
						'MULTI' => 'N',
			...
			$akkumSectionID = CNextCacheB2c::CIBlockSection_GetList(
				array(
					'CACHE' => array(
						'TAG' => CNextCacheB2c::GetIBlockCacheTag($catalogIBlockID),
						'MULTI' => 'N',
