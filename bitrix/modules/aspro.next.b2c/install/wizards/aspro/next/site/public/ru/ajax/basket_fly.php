...
$APPLICATION->IncludeComponent("bitrix:sale.basket.basket", "fly", array(
	...
	"PICTURE_WIDTH" => "70",
	"PICTURE_HEIGHT" => "70",
	"PATH_TO_BASKET" => CNextB2c::GetFrontParametrValue("BASKET_PAGE_URL"),
	"PATH_TO_ORDER" => CNextB2c::GetFrontParametrValue("ORDER_PAGE_URL"),
	"PATH_TO_AUTH" => SITE_DIR."auth/",
	"PATH_TO_COMPARE" => CNextB2c::GetFrontParametrValue("COMPARE_PAGE_URL"),
