...
if(isset($_SESSION["NEXT_CATALOG_ID"]) && $_SESSION["NEXT_CATALOG_ID"])
	\Bitrix\Main\Config\Option::set("aspro.next.b2c", "CATALOG_IBLOCK_ID", $_SESSION["NEXT_CATALOG_ID"], WIZARD_SITE_ID);
\Bitrix\Main\Config\Option::set("aspro.next.b2c", "MAX_DEPTH_MENU", 4, WIZARD_SITE_ID);
\Bitrix\Main\Config\Option::set("aspro.next.b2c", "REGIONALITY_FILTER_ITEM", "Y", WIZARD_SITE_ID);

$catalogIBlockID = CNextCacheB2c::$arIBlocks[WIZARD_SITE_ID]["aspro_next_catalog"]["aspro_next_catalog"][0];
$landingIBlockID = CNextCacheB2c::$arIBlocks[WIZARD_SITE_ID]['aspro_next_catalog']['aspro_next_catalog_info'][0];
$servicesIBlockID = CNextCacheB2c::$arIBlocks[WIZARD_SITE_ID]['aspro_next_content']['aspro_next_services'][0];
...
$brandsIBlockID = CNextCacheB2c::$arIBlocks[WIZARD_SITE_ID]['aspro_next_content']['aspro_next_brands'][0];
