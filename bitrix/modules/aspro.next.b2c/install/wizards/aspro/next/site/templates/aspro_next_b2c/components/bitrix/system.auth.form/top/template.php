...
<?else:?>
	<div class="module-enter have-user">
		...
		global $USER;
		$arPhoto=array();
		$arUser=CNextCacheB2c::CUser_GetList(array("SORT"=>"ASC", "CACHE" => array("MULTI" => "N", "TAG"=>CNextCacheB2c::GetUserCacheTag($USER->GetID()))), array("ID"=>$USER->GetID()), array("FIELDS"=>array("ID", "PERSONAL_PHOTO")));
