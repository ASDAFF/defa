...
Option::set("socialservices", "auth_services", serialize($arServices));
Option::set("aspro.next.b2c", "WIZARD_SITE_ID", WIZARD_SITE_ID, WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "SITE_INSTALLED", "Y", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "USE_FILTERS", "Y", WIZARD_SITE_ID);
...
// new options
Option::set("aspro.next.b2c", "ORDER_BASKET_VIEW", "FLY", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "INDEX_TYPE", "index1", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "STORES_SOURCE", "IBLOCK", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "TYPE_SKU", "TYPE_1", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "MAX_DEPTH_MENU", "3", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "FILTER_VIEW", "VERTICAL", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "USE_FAST_VIEW_PAGE_DETAIL", "fast_view_1", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "SHOW_BASKET_ONADDTOCART", "Y", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "USE_PRODUCT_QUANTITY_LIST", "Y", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "USE_PRODUCT_QUANTITY_DETAIL", "Y", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "BUYNOPRICEGGOODS", "NOTHING", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "BUYMISSINGGOODS", "ADD", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "EXPRESSION_ORDER_BUTTON", ($isUTF8 ? iconv('CP1251', 'UTF-8', '��� �����') : '��� �����'), WIZARD_SITE_ID);
...
Option::set("aspro.next.b2c", "SHOW_QUANTITY_FOR_GROUPS", $DefaultGroupID, WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "SHOW_QUANTITY_COUNT_FOR_GROUPS", $DefaultGroupID, WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "EXPRESSION_FOR_EXISTS", ($isUTF8 ? iconv('CP1251', 'UTF-8', '���� � �������') : '���� � �������'), WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "EXPRESSION_FOR_NOTEXISTS", ($isUTF8 ? iconv('CP1251', 'UTF-8', '��� � �������') : '��� � �������'), WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "USE_WORD_EXPRESSION", "Y", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "MAX_AMOUNT", 10, WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "MIN_AMOUNT", 2, WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "USE_REGIONALITY", "N", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "REGIONALITY_TYPE", "ONE_DOMAIN", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "SHOW_REGION_CONTACT", "Y", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "PRINT_BUTTON", "N", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "SHOW_BASKET_ON_PAGES", "N", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "VIEWED_TEMPLATE", "HORIZONTAL", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "VIEWED_TYPE", "LOCAL", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "ADV_SIDE", "Y", WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "EXPRESSION_FOR_MIN", ($isUTF8 ? iconv('CP1251', 'UTF-8', '����') : '����'), WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "EXPRESSION_FOR_MID", ($isUTF8 ? iconv('CP1251', 'UTF-8', '����������') : '����������'), WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "EXPRESSION_FOR_MAX", ($isUTF8 ? iconv('CP1251', 'UTF-8', '�����') : '�����'), WIZARD_SITE_ID);
Option::set("aspro.next.b2c", "MIN_ORDER_PRICE_TEXT", ($isUTF8 ? iconv('CP1251', 'UTF-8', '<b>����������� ����� ������ #PRICE#</b><br/>����������, �������� ��� ������� � �������') : '<b>����������� ����� ������ #PRICE#</b><br/>����������, �������� ��� ������� � �������'), WIZARD_SITE_ID);
