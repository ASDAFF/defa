...
<?if(isset($_POST["AJAX_REQUEST_INSTAGRAM"]) && $_POST["AJAX_REQUEST_INSTAGRAM"] == "Y"):
	$inst=new CInstargramNextB2c($arParams["TOKEN"], \Bitrix\Main\Config\Option::get("aspro.next.b2c", "INSTAGRAMM_ITEMS_COUNT", 8));
	...
	if($arInstagramPosts && !$arInstagramPosts["meta"]["error_message"]):?>
		...
		$text_length = \Bitrix\Main\Config\Option::get("aspro.next.b2c", "INSTAGRAMM_TEXT_LENGTH", 400);?>
		<div class="item-views front blocks">
			...
			<div class="instagram clearfix">
				<?$iCountSlide = \Bitrix\Main\Config\Option::get("aspro.next.b2c", "INSTAGRAMM_ITEMS_VISIBLE", 4);?>
	...
	<?endif;?>
<?else:?>
	<div class="instagram_wrapper wide_<?=\Bitrix\Main\Config\Option::get("aspro.next.b2c", "INSTAGRAMM_WIDE_BLOCK", "N");?>">
