...
$bUseFeedback = CNextB2c::GetFrontParametrValue('CONTACTS_USE_FEEDBACK', SITE_ID) != 'N';
?>
...
<div class="contacts maxwidth-theme" itemscope itemtype="http://schema.org/Organization">
	<div class="row">
		<div class="<?=($bUseMap ? 'col-md-4' : 'col-md-12')?>">
			...
			<table>
				<tbody>
					<?CNextB2c::showContactAddr('Адрес', false);?>
					<?CNextB2c::showContactPhones('Телефон', false);?>
					<?CNextB2c::showContactEmail('E-mail', false);?>
					<?CNextB2c::showContactSchedule('Режим работы', false);?>
				</tbody>
			</table>
		</div>
		<?if($bUseMap):?>
...
<?if($bUseFeedback):?>
	...
	<?$APPLICATION->IncludeComponent("bitrix:form.result.new", "inline",
		Array(
			...
			"HIDDEN_CAPTCHA" => CNextB2c::GetFrontParametrValue('HIDDEN_CAPTCHA'),
			"CHAIN_ITEM_TEXT" => "",
			"CHAIN_ITEM_LINK" => "",
