...
if(Option::get("aspro.next.b2c", "wizard_installed", "N") == 'N'){
	...
	//fclose($file);
	Option::set("aspro.next.b2c", "wizard_installed", "Y");
}
...
// phone
$phones = Option::get('aspro.next.b2c', "HEADER_PHONES", $iCountPhones, WIZARD_SITE_ID);
Option::set('aspro.next.b2c', "HEADER_PHONES", $iCountPhones, WIZARD_SITE_ID);
if($iCountPhones)
{
	foreach($arPhones as $key => $value)
	{
		Option::set('aspro.next.b2c', "HEADER_PHONES_array_PHONE_VALUE_".$key, $value, WIZARD_SITE_ID);
	}
}
else
{
	if($phones)
	{
		for($i = 0; $i <= $phones; ++$i)
		{
			Option::delete('aspro.next.b2c', array("name" => "HEADER_PHONES_array_PHONE_VALUE_".$i, "site_id" => WIZARD_SITE_ID));
		}
	}
}
...
// socials
Option::set('aspro.next.b2c', "SOCIAL_VK", $wizard->GetVar("shopVk"), WIZARD_SITE_ID);
Option::set('aspro.next.b2c', "SOCIAL_FACEBOOK", $wizard->GetVar("shopFacebook"), WIZARD_SITE_ID);
Option::set('aspro.next.b2c', "SOCIAL_TWITTER", $wizard->GetVar("shopTwitter"), WIZARD_SITE_ID);
Option::set('aspro.next.b2c', "SOCIAL_YOUTUBE", $wizard->GetVar("shopYoutube"), WIZARD_SITE_ID);
Option::set('aspro.next.b2c', "SOCIAL_INSTAGRAM", $wizard->GetVar("shopInstagram"), WIZARD_SITE_ID);
Option::set('aspro.next.b2c', "SOCIAL_TELEGRAM", $wizard->GetVar("shopTelegram"), WIZARD_SITE_ID);
Option::set('aspro.next.b2c', "SOCIAL_ODNOKLASSNIKI", $wizard->GetVar("shopOdnoklassniki"), WIZARD_SITE_ID);
Option::set('aspro.next.b2c', "SOCIAL_GOOGLEPLUS", $wizard->GetVar("shopGooglePlus"), WIZARD_SITE_ID);
Option::set('aspro.next.b2c', "SOCIAL_MAIL", $wizard->GetVar("shopMailRu"), WIZARD_SITE_ID);
