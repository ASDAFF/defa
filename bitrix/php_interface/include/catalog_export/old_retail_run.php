...
{
//function yandex_get_value($arOffer, $param, $PROPERTY, $arProperty, $arUserTypeFormat, $usedProtocol)
...
else
{
	...
	if (!empty($arOffers['IBLOCK_ID']))
	{
		...
		{$strExportErrorMessage .= dump($XML_DATA);$strExportErrorMessage .= "<br>----------------------<br>";
			$boolOffers = true;
			$rsProps = CIBlockProperty::GetList(
				array('SORT' => 'ASC', 'NAME' => 'ASC'),
