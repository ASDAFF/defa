...
?>
    ...
    <div class="row government">
        <div class="col-lg-12">
            <p class="text-no-all-width">
                Компания "ДЭФО" осуществляет послегарантийное обслуживание и ремонт мебели, замену составных элементов или комплектующих. Для связи с сотрудниками отдела послепродажного обслуживания воспользуйтесь телефонами и адресами, находящимися в разделе контакты.
            </p>
        </div>
    </div>
