...
?>
    <div class="top_block">
        <h3 class="title_block big">Как заказать товар?</h3>
    </div>

    <div class="row government how-buy advantages">
        <div class="col-lg-6 how-buy-item sait">
            <h4 class="how-buy-title">На сайте</h4>
            <p class="how-buy-text">
                Для этого достаточно выбрать понравившийся вам товар в каталоге, положить его в виртуальную корзину и оформить покупку.
            </p>
            <ul>
                <li>Заказ через корзину</li>
                <li>Быстрый заказ</li>
            </ul>
        </div>
        <div class="col-lg-6 how-buy-item tel">
            <h4 class="how-buy-title">По телефону</h4>
            <p class="how-buy-text">
                Наши операторы проконсультируют вас по вопросам, связанным с техническими характеристиками и потребительскими свойствами
            </p>
        </div>
    </div>
    ...
    <div class="row government how-buy advantages">
        ...
        <div class="col-lg-6 how-buy-item mail">
            <h4 class="how-buy-title">По электронной почте</h4>
            <p class="how-buy-text">
                В письме необходимо указать наименования (коды) выбранных вами товаров и их количество, а также данные о себе: имя, фамилию, телефон, персональный код (если он у вас есть)
            </p>
        </div>
        <div class="col-lg-6 how-buy-item salons">
            <h4 class="how-buy-title">В любом удобном для вас салоне</h4>
            <p class="how-buy-text">
                Для этого достаточно выбрать понравившийся вам товар в каталоге, положить его в виртуальную корзину и оформить покупку.
            </p>
        </div>
