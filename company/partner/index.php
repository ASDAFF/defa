    ...
    <div class="row price-quality price-quality-partners partners">
        ...
        <div class="col-md-12 a11y-price">
            <div>
                ...
                <p>“ДЭФО” предлагает своим клиентам услугу«офис под ключ». Для этого нам требуются компетентные и ответственные подрядчики,которые примут участие в создании функциональных и современных офисных интерьеров. Если Вы заинтересованы в сотрудничестве и совместной работе - мы открыты к предложениям!</p>
                <a href="#" class="grey-btn">Стать партнером</a>
            </div>
            <img src="/images/partners-1.jpg" alt="" width="656" height="271">
        </div>
